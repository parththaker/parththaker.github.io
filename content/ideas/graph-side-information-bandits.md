...
The interesting open direction is how far this generalizes: which structural
priors (graphs, low-rank reward matrices, metric spaces) give provable savings,
and which are just heuristics that happen to work. The GRUB line of work (see
the [project](/projects/grub-graph-bandits/)) is the graph instance of this
question; I keep coming back to the more general version.
