...
export const metadata: Metadata = {
  ...
  description: "AI Research Engineer at Intuitive Surgical. Ph.D. in Electrical Engineering from ASU. Specializing in nonconvex optimization, graph theory, bandit learning, and secure LLM workflows.",
  keywords: [
    "Parth Thaker",
